...
#pragma region Temperature
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, meta = (AllowPrivateAccess = "true", ToolTip = "Number of Seconds between Temperature Updates"), Category = "Chrono|Temperature")
